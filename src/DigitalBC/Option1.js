...
export default function Option1(props) {
    return(
            ...
            <div className="child-mid-box">
                ...
                <div className="midbox-about-text">I am a front-end developer with a particular interest in making things simple and automating daily tasks. I try to keep up with security and best practices, and am always looking for new things to learn.</div>
