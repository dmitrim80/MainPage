  ...
  return (
    <div className="box">
      ...
      <div className="child-mid-box">
        ...
        <div className="midbox-about-text">
        ...
        <div className="midbox-interests-text">
          Marine & aquatic-life Enthusiast. Coral restoration. Intermediate
          level rowers. Love sports. Entrepreneur. Travel geek. Coffee fanatic.
        </div>
      </div>
